...
function resetForm() {
    ...
    document.getElementById("col").value = 6;
    createEventListeners();
}

function createEventListeners() {
    //document.getElementById("btnGenerateTable").addEventListener("click", createTableObjectOriented, false);
	document.getElementById("row").addEventListener("change", createTableObjectOriented, false);
	document.getElementById("col").addEventListener("change", createTableObjectOriented, false);
}

window.addEventListener("load", resetForm, false);
window.onload = createTableObjectOriented;
